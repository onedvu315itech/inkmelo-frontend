...
import { handlerActiveItem, useGetMenuMaster } from "api/userMenu";
import { Link, matchPath, useLocation } from "react-router-dom";
import { forwardRef, useEffect } from 'react';

export default function UserNavItem({ item, level }) {
...
UserNavItem.propTypes = { item: PropTypes.object, level: PropTypes.number };